...
#from models.SGC_model import SGC
from models.SAGE_model import Sage
...
class Baseline(nn.Module):
    ...
    def __init__(self, model_name, in_feats, h_feats, num_classes, graph, lr = 5e-3, epochs=100, verbose=1):
        ...
        if model_name == "iforest":
            ...
            self.model = SGC(in_feats, h_feats, num_classes, self.graph)
            self.optimizer = Adam(self.model.parameters(), lr = self.lr)
        elif model_name == "sage":
            self.model = Sage(in_feats, h_feats, num_classes, self.graph)
            self.optimizer = Adam(self.model.parameters(), lr = self.lr)
    def fit(self):
